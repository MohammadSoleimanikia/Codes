...
app.post("/submit", (req, res) => {
  ...
  let randNum=Math.floor(Math.random()*adj.length)
  let randAdj=adj[randNum];
  randNum=Math.floor(Math.random()*noun.length)
  let randNoun=noun[randNum];
  //scroll down to see the two arrays.
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render('index.ejs',{noun:randNoun,adj:randAdj})
